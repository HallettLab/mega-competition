...
N[,,1] <- 1000 # start with 100 individuals in every case
...
ggplot(residents_wet_long, aes(x=num, y=equil_abund)) +
  ...
  ggtitle("Ambient Conditions, Equilibrium, Nt1 = 1000, 12/18/23")

ggsave(paste0("analyses/classic_MCT/preliminary_equil_abundance/", date, "/equil_abund_ricker_negbinom_C_Nt1000_", date, ".png"), height = 6, width = 10)
...
ggplot(residents_wet_long, aes(x=equil_abund)) +
  geom_histogram() +
  facet_wrap(~species, scales = "free") +
  # xlab("Run Number") + 
  xlab("Equilibrium Abundance")
# ggtitle("Ambient Conditions, Equilibrium, Nt1 = 1000, 12/18/23")
