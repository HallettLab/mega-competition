...
png(file = paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", species, "_pairs_plot_epsilon_sigma_lambda.png"), width = 1800, height = 1800)
