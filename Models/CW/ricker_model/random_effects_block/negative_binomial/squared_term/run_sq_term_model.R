...
for(i in species){
  ...
  # Model ####
  model.output[[paste0("ricker_",i)]] <- stan(file = 'Models/CW/ricker_model/random_effects_block/negative_binomial/squared_term/CRW_ricker_RE_neg_binomial_sq_term_ACAM.stan', 
  ...
  ## save model output
  save(PrelimFit, file = paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/squared_term/posteriors/ricker_", i, "_posteriors_random_effects_neg_binomial_sq_term", date, ".rdata"))
