...
model{
  ...
  alpha_acam_sq_base ~ normal(0,5);
  alpha_acam_sq_dev ~ normal(0,5);
  ...
  for(i in 1:N){
    ...
    pow(acam[i],2)*(alpha_acam_sq_base + alpha_acam_sq_dev*trt[i]) -
