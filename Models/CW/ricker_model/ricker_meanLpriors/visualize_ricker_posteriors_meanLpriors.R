...
for(i in species){
  ...
  ggsave(alpha, file=paste0("models/CW/ricker_model/posterior_figures/mean_L_priors/", "alpha_", tolower(i), "_ricker_meanLpriors_constrainedby_", k, "_", date, ".png"), width = 12, height = 9)
  ...
  ggsave(invader, file=paste0("models/CW/ricker_model/posterior_figures/mean_L_priors/", "invader_", i, "_inter_alphas_ricker_meanLpriors_constrainedby_", k, "_", date, ".png"), width = 12, height = 8)
