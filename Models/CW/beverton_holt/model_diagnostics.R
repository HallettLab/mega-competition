...
ggsave(paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_random_effects_traceplot_", date, ".png"), width = 8, height = 4)

### lambda_base
traceplot(PrelimFit, pars = c("lambda_base", "lambda_dev", "disp_dev"))

ggsave(paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_lambda_traceplot_", date, ".png"), width = 6, height = 3)
...
ggsave(paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species,  "_alphas1_traceplot_", date, ".png"), width = 8, height = 4)
...
ggsave(paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_alphas2_traceplot_", date, ".png"), width = 8, height = 4)
...
ggsave(paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_alphas3_traceplot_", date, ".png"), width = 8, height = 4)

## Pairs plots ####
### epsilon/sigma/lambda
png(file = paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_pairs_plot_epsilon_sigma_lambda.png"), width = 1800, height = 1800)
...
### alpha 1/lambda
png(file = paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_pairs_plot_lambda_alphas1.png"), width = 1800, height = 1800)
...
### alpha 2/lambda
png(file = paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_pairs_plot_lambda_alphas2.png"), width = 1800, height = 1800)
...
### alpha 3/lambda
png(file = paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_pairs_plot_lambda_alphas3.png"), width = 1800, height = 1800)
...
### alpha, epsilon, sigma
png(file = paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_pairs_plot_epsilon_sigma_alpha1.png"), width = 1800, height = 1800)
...
png(file = paste0("Models/CW/ricker_model/random_effects_block/negative_binomial/posterior_diagnostics/", date, "/", species, "/", species, "_pairs_plot_epsilon_sigma_2_alpha1.png"), width = 1800, height = 1800)
