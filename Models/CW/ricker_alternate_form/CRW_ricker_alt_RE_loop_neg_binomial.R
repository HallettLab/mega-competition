...
# Model ####
  model.output[[paste0("ricker_",i)]] <- stan(file = 'Models/CW/ricker_alternate_form/CRW_ricker_alt_RE_neg_binomial_BRHO.stan', 
...
## save model output
  save(PrelimFit, file = paste0("Models/CW/ricker_alternate_form/posteriors/ricker_alt_", i, "_posteriors_random_effects_neg_binomial", date, ".rdata"))
