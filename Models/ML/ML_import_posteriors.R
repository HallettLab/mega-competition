...
species <- c("PLER", "BRHO", "GITR", "AVBA", "ANAR", "MAEL", 
 "CLPU", "TACA", "LOMU", "TWIL", "THIR", "CESO", "MICA", "AMME", "PLNO", "ACAM")
...
for(i in species){
  for(j in trt){
    load(paste0("Models/Posteriors/ML_normal_bounded/seeds_", i, "_", j, "_posteriors.rdata"))
