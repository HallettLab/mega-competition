...
for(j in 1:nrow(comp14)){
  ...
  for(r in 1:length(rainfall)){
    ...
    prep <- posts_clean %>%
      ...
      select(species, lambda_c, paste0("alpha_", tolower(cc[1]), rain), paste0("alpha_", tolower(cc[2]), rain), paste0("alpha_", tolower(cc[3]), rain), paste0("alpha_", tolower(cc[4]), rain), paste0("alpha_", tolower(cc[5]), rain), paste0("alpha_", tolower(cc[6]), rain), paste0("alpha_", tolower(cc[7]), rain), paste0("alpha_", tolower(cc[8]), rain), paste0("alpha_", tolower(cc[9]), rain), paste0("alpha_", tolower(cc[10]), rain), paste0("alpha_", tolower(cc[11]), rain), paste0("alpha_", tolower(cc[12]), rain), paste0("alpha_", tolower(cc[13]), rain), paste0("alpha_", tolower(cc[14]), rain))
    ...
    for (i in 1:length(draws)) {
      ...
      prep2 <- prep[c(d, (d + 3750), (d+(2*3750)), (d+(3*3750)), (d+(4*3750)), (d+(5*3750)), (d+(6*3750)), (d+(7*3750)), (d+(8*3750)), (d+(9*3750)), (d+(10*3750)), (d+(11*3750)), (d+(12*3750)), (d+(13*3750))),] 
      
      ## rename
      names(prep2) <- c("sp", "lambda", cc[1], cc[2], cc[3], cc[4], cc[5], cc[6], cc[7], cc[8], cc[9], cc[10], cc[11], cc[12], cc[13], cc[14])
      ...
      write.table(output_row, "analyses/interactions_v_traits/structural_coexistence/run_structural/structural_results_files/14_sp_structural_results_20240917.csv", append = TRUE, row.names = FALSE, sep = ",", col.names = FALSE)
