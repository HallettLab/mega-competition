...
fig_loc = "analyses/interactions_v_traits/structural_coexistence/prelim_figs/sept_2024/sp15/"

## read in data
### coexistence metrics/indirect interactions
sp15 = read.csv(paste0(file_path, "run_structural/structural_results_files/sp15/15_sp_structural_results_20240917.csv"))
