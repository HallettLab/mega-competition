...
# Visualize ####
## RAINFALL ####
pf = ggplot(sp10sum, aes(x=rainfall, y=prop_feasible)) +
...
nd = ggplot(sp10sum, aes(x=rainfall, y=mean_niche)) +
  geom_jitter(alpha = 0.15) +
...
fd = ggplot(sp10sum, aes(x=rainfall, y=mean_fitness)) +
  geom_jitter(alpha = 0.15) +
...
## ORIGIN ####
lpfo = ggplot(sp10sum, aes(x=as.factor(num.inv), y=log(prop_feasible))) +
  geom_jitter(alpha = 0.15) +
...
pfo = ggplot(sp10sum, aes(x=as.factor(num.inv), y=prop_feasible)) +
  geom_jitter(alpha = 0.15) +
...
ndo = ggplot(sp10sum, aes(x=as.factor(num.inv), y=mean_niche)) +
  geom_jitter(alpha = 0.15) +
  ylab("Niche Differences") +
  xlab("Number of Invasive Species") +
  theme(text = element_text(size = 15)) +
...
fdo = ggplot(sp10sum, aes(x=as.factor(num.inv), y=mean_fitness)) +
  geom_jitter(alpha = 0.15) +
  ylab("Fitness Differences") +
  xlab("Number of Invasive Species") +
  theme(text = element_text(size = 15)) +
...
## FDIV ####
fdivpf = ggplot(sp10sum, aes(x=fdiv, y=prop_feasible)) +
  geom_point() +
...
fdivnd = ggplot(sp10sum, aes(x=fdiv, y=mean_niche)) +
  geom_point() +
  geom_smooth(method = "lm") +
  ylab("Niche Differences") +
...
fdivfd = ggplot(sp10sum, aes(x=fdiv, y=mean_fitness)) +
  geom_point() +
  geom_smooth(method = "lm") +
  ylab("Fitness Differences") +
  xlab("") +
...
cpdpf = ggplot(sp10sum, aes(x=mean_cpd, y=prop_feasible)) +
  geom_point() +
  geom_smooth(method = "lm") +
  ylab("Proportion of Coexistence") +
  xlab(" ") +
...
cpond = ggplot(sp10sum, aes(x=mean_cpo, y=mean_niche)) +
  geom_point() +
  geom_smooth(method = "lm") +
  ylab("Niche Differences") +
  xlab("Community Pair Overlap") 

cpdnd = ggplot(sp10sum, aes(x=mean_cpd, y=mean_niche)) +
  geom_point() +
  geom_smooth() +
  ylab("Niche Differences") +
...
cpofd = ggplot(sp10sum, aes(x=mean_cpo, y=mean_fitness)) +
  geom_point() +
  geom_smooth(method = "lm") +
  ylab("Fitness Differences") +
  xlab(" ") 

cpdfd = ggplot(sp10sum, aes(x=mean_cpd, y=mean_fitness)) +
  geom_point() +
  geom_smooth(method = "lm") +
  ylab("Fitness Differences") +
  xlab(" ") +
